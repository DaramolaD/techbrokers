...
const footerSections = [
  {
    ...
    links: [
      ...
      { name: "Fintech Solutions", href: "/services" },
      { name: "Government Innovation", href: "/services" },
      { name: "Startup Acceleration", href: "/services" },
      { name: "Consultants", href: "/services" }
    ]
  },
  {
    title: "Company",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="p-3 rounded-lg bg-white flex items-center justify-center">
                <span className="text-[#1E40AF] font-bold text-xl">TB</span>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4">
              <Link href="/contact" className="inline-flex items-center px-4 py-2 border border-white bg-[#1E40AF] text-white rounded-md hover:bg-[#1E40AF]/90 transition-colors">
                Get in Touch
              </Link>
            </div>
          </div>
